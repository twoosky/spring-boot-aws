...
// @WebMvcTest는 JPA 기능이 작동하지 않고, Controller, ControllerAdvice 등 외부 연동과 관련된 부분만 활성화 된다.
// 그러므로, JPA 기능까지 한번에 테스트 할 때는 @SpringBootTest 사용
...
public class PostsApiControllerTest {
    ...
    @Test
    // @WithMockUser
    // : 인증된 모의(가짜) 사용자를 만들어서 사용하는 어노테이션
    // - roles에 권한을 추가할 수 있다.
